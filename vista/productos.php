            ...
            <div class="modal-body">
                <form method="post" id="f" autocomplete="off">
                    ...
                    <div class="form-row mb-3">
                        <div class="col-md-4">
                        <label for="fk_estado"
                     class="bmd-label-floating text-gray-900">Proveedor</label>
                    <select class="form-control" name="proveedor" id="proveedor">
                       <?php echo $proveedores; ?>
                       </select>
                      <span id="sfk_parroquia" class="input-span"></span>
                        </div>
                        <div class=" col-md-4">
                                                <div class="form-group">
                                                    <label for="fk_estado"
                                                        class="bmd-label-floating text-gray-900">Categoria</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <span id="salmacen" class="text-danger"></span>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12">
